...
fig.write_image("imgs/3d_plot_original.png", scale=2)
...
plt.savefig('imgs/elbow_plot.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.savefig('imgs/silhouette_plot.png', bbox_inches='tight', dpi=300)
plt.show()
...
fig.show()
fig.write_image("imgs/3d_cluster_online.png", scale=2)
...
fig = px.scatter_3d(cartao_cluster, 
                    ...
                    color='cluster_kmeans')
fig.show()
fig.write_image("imgs/3d_cluster_bank.png", scale=2)
...
fig = px.scatter_3d(cartao_cluster, 
                    ...
                    color='cluster_kmeans')
fig.show()
fig.write_image("imgs/3d_cluster_calls.png", scale=2)
